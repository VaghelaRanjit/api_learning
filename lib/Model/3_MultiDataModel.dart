...
class MultiDataModel {
  ...
  factory MultiDataModel.fromRawJson(String str) => MultiDataModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory MultiDataModel.fromJson(Map<String, dynamic> json) => MultiDataModel(
